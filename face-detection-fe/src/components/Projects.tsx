...
} from "@/components/example/animated-beam-multiple-outputs";
import { BentoCard, BentoGrid } from "@/components/magicui/bento-grid";
import Marquee from "@/components/magicui/marquee";
import { CalendarIcon, RocketIcon, InputIcon } from "@radix-ui/react-icons";
...
const features = [
  {
    Icon: RocketIcon,
    name: "Face Detection ML",
    description: "Upload an image with face and see the magic",
    href: "/face-detection",
    cta: "Learn more",
